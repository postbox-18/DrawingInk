...
import com.example.drawingink.R;
...
public class ErrorActivity extends Activity
{
  ...
  private String TAG="ErrorActivity";
  @Override
  protected void onCreate(@Nullable Bundle savedInstanceState)
  {
    ...
    Log.e(TAG,"texts>>38>>"+ getIntent().getStringExtra(INTENT_EXTRA_MESSAGE));

    TextView detailsView = findViewById(R.id.error_details);
    detailsView.setText(getIntent().getStringExtra(INTENT_EXTRA_DETAILS));
    Log.e(TAG,"texts>>42>>"+ getIntent().getStringExtra(INTENT_EXTRA_DETAILS));
